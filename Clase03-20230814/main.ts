...
const edades : number[] = [30, 35, 45, 55] /* Las edades van a estar en un array, que va a ser numérico */
...
const programador: Programador = new Programador('Juan', 20)
...
class Entidad{
    ...
    atacarObjetivo(objetivo: string): void {
        console.log(this.nombre + ' ataca a ' + objetivo + ', y le inflingió un daño de ' + this.danio)
    }
    atacadoPorEnemigo(atacante: string, danio2: number): void {
...
const stubbs: Zombie = new Zombie('Stubbs', 30)
